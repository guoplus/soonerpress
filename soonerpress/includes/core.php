...
function _sp_default_scripts() {
	...
	wp_register_script( 'jquery.cookie', SP_JS . '/jquery.cookie.min.js', array( 'jquery' ), '1.4.0', true );
...
foreach ( array( 'functions', 'for-developers', 'adjacent-post-link', 'custom-meta', 'term-meta' ) as $m ) {
...
function _sp_core_enqueue_assets_dashboard() {
	...
	wp_localize_script( 'sp.core.dashboard', 'sp_core_l10n', array(
