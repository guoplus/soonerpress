...
function sp_breadcrumb( $echo = true ) {
	$sp_breadcrumb = new SP_Breadcrumb();
	if ( $echo )
		echo $sp_breadcrumb->get_output();
	else
		return $sp_breadcrumb->get_output();
}


class SP_Breadcrumb extends SP_Module {
	...
	private function breadcrumb() {
		if ( ! $this->c['show_in_home'] && ( is_home() || is_front_page() ) )
			return;
